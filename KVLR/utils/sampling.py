...
from KVLR.models.mmdit.model import MMDiTModel
from KVLR.models.text.conditioner import HFEmbedder
from KVLR.registry import MODELS, build_module
...
class I2VDenoiser(Denoiser):
    def denoise(self, model: MMDiTModel, **kwargs) -> Tensor:
        ...
        if hasattr(model, "clear_adaptive_cache"):
            model.clear_adaptive_cache()
