...
KVLR_CKPT_ROOT = os.environ.get("KVLR_CKPT_ROOT", "./checkpoints/base")
...
fps_save = 30  # fps for video generation and saving

# Define model components
model = dict(
    type="flux",
    from_pretrained=os.path.join(KVLR_CKPT_ROOT, "stage1_i2v", "merged_model.safetensors"),
